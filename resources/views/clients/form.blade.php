        ...
        <div class="container">
            <div class="row margin-y-30">
                ...
                <div class="col s12 m6 right-align">
                    ...
                    @if(! is_null($client))
                        <form name="delete-client-form" id="delete-client-form" class="display-inline-block">
                            {!! csrf_field() !!}
                            <button type="submit" form="delete-client-form" formaction="{{ route('clients.handleDelete', ['client_id' => $client->getKey()]) }}" formmethod="POST" class="waves-light waves-effect btn red darken-1 margin-left-15">Delete</button>
                        </form>
                    @endif
                </div>
            </div>
